...
<head>
  ...
  <title>VKRdownloaderPro : Download Any Videos From Any Sites - Best Downloader [<?php echo date("Y/m/d"); ?>]</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="/">VKRdownloaderPro</a></h1>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>VKRdownloaderPro</span></strong>. All Rights Reserved <?php echo date("Y/m/d"); ?>
        </div>
        <div class="credits">
